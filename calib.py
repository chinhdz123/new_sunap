...
def calib(img):
    ...
    # jpg files alone
    # images = glob.glob('tmp\check_sunap1\*.jpg')
    
    # for filename in images:
    image = cv2.imread(r"C:\Users\Admin\Downloads\check_xupap.jpg")
...
# cv2.imshow("1",calib(cv2.imread(r"C:\Users\Admin\Downloads\4.bmp")))
# cv2.waitKey(0)
